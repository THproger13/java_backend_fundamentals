...
public class BankService {
    ...
    public void accountsave() {
            ...
            boolean result = bankRepository.cheakaccount(accountNumber);
            if (result) {
...
//account의 전체 거래내역을 출력
    ...
    public void showDepositHistory(String accountNumber) {
        List<AccountDTO> accountDeposits = bankRepository.showDepositHistory();
    ...
    public void showWithdrawHistory(String accountNumber) {
        List<AccountDTO> accountWithdraws = bankRepository.showWithdrawHistory();
